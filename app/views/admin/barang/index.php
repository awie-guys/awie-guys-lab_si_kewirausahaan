...
<div class="main-content">
    <?php include '../app/views/layouts/navbar1.php'; ?>
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="/admin/barang/create" class="btn btn-success px-4" style="background: var(--primary-green); border-radius: 10px; border:none;"> 
    ...
    <div class="table-section mt-3">
            ...
            <table class="table table-hover align-middle">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>1</td>
                        <td class="text-muted fw-bold">BRG001</td>
                        <td>
                            <div class="d-flex align-items-center gap-2">
                                <div class="img-item">📦</div>
                                <span>Pulpen Standard</span>
                            </div>
                        </td>
                        <td>Alat Tulis</td>
                        <td>pcs</td>
                        <td>Rp2.000</td>
                        <td style="color: #2e7d32;">120</td>
                        <td>20</td>
                        <td><span class="status-badge status-aktif">Aktif</span></td>
                        <td class="text-center">
                            <a href="/admin/barang/edit/1" class="btn btn-action btn-success me-1" style="background:#008a34; border:none;">
                                <i class="fas fa-edit"></i>
                            </a>
                            <button class="btn btn-action btn-danger" style="background:#dc3545; border:none;">
        ...
        <div class="d-flex justify-content-between align-items-center mt-3">
            <span class="text-muted small">Menampilkan 1 data (Preview Mode)</span>
            <nav>
